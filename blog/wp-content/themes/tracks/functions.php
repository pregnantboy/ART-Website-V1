...
function wpbootstrap_scripts_with_jquery()
{
	...
	wp_enqueue_script( 'fittext',  get_template_directory_uri() . '/js/jquery.fittext.js', array( 'jquery' ) );
	wp_enqueue_script( 'wow',  get_template_directory_uri() . '/js/wow.min.js', array( 'jquery' ) );
	wp_enqueue_script( 'onlaunch',  get_template_directory_uri() . '/js/onlaunch.js', array( 'jquery' ) );
}
add_action( 'wp_enqueue_scripts', 'wpbootstrap_scripts_with_jquery' );

function scripts_with_footer() {
	wp_enqueue_script( 'creative',  get_template_directory_uri() . '/js/creative.js', array( 'jquery', 'easing' ) );
...
add_action( 'wp_footer', 'scripts_with_footer' );
